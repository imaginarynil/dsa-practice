...
public class zero_matrix {
    static void printMatrix(int[][] input, int rowCount, int colCount) {
    ...
    static void solve(int[][] input, int rowCount, int colCount){
    ...
    static void nullifyRow(int[][] input, int row, int colCount) {
        for(int i = 0; i < colCount; i++) {
            input[row][i] = 0;
        }
    }

    static void nullifyCol(int[][] input, int col, int rowCount) {
        for(int i = 0; i < rowCount; i++) {
            input[i][col] = 0;
        }
    }

    static void book_solution_1(int[][] input, int rowCount, int colCount) {
    ...
    static void main(){
        ...
        System.out.println();
        book_solution_1(input, input.length, input[0].length);
        printMatrix(input, input.length, input[0].length);
    }
}
